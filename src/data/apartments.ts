...
export const apartments: Apartment[] = [
  ...
  },
  {
    ...
    neighborhood: {
      vibe: 'Vibrant and family-friendly with a creative atmosphere',
      walkScore: 94,
      highlights: ['Grünerløkka 5 min away', 'Mathallen within walking distance', 'Many parks in the neighborhood'],
      nearbySpots: [
        { name: 'Mathallen', type: 'Food Hall', distance: '7 min' },
        { name: 'Grünerløkka', type: 'Neighborhood', distance: '5 min' },
        { name: 'Birkelunden', type: 'Park', distance: '6 min' },
        { name: 'Schous Plass Tram', type: 'Transport', distance: '4 min' },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    neighborhood: {
      vibe: 'Central and lively — surrounded by parks and local gems',
      walkScore: 96,
      highlights: ['St. Hanshaugen Park', 'Bislett Stadium nearby', 'Hip nightlife and food scene'],
      nearbySpots: [
        { name: 'St. Hanshaugen', type: 'Park', distance: '4 min' },
        { name: 'Bislett Kebab', type: 'Restaurant', distance: '2 min' },
        { name: 'Adamstuen Tram', type: 'Transport', distance: '3 min' },
